...
![一段代码的性能](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/一段代码的性能.png)
...
![可达对象图示](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/可达对象图示.png)
...
![GC里的垃圾是什么](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/GC里的垃圾是什么.png)
...
![标记清除](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/标记清除.png)
...
![标记清除算法缺点图解](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/标记清除算法缺点图解.png)
...
![整理清除回收前](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/整理清除回收前.png)

执行标记整理，会将活动对象进行整理，地址变为连续

![整理清除整理后](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/整理清除整理后.png)

这样回收后就可以最大化利用空间

![整理清除回收后](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/整理清除回收后.png)
...
![V8内存策略](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/V8内存策略.png)
...
![标记增量](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/标记增量.png)
...
![Timeline记录内存](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/Timeline记录内存.png)
...
![V8引擎](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/V8引擎.png)
...
![优化慎用全局变量](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/优化慎用全局变量.png)
...
![优化缓存数据](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/优化缓存数据.png)
...
![优化减少访问层级](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/优化减少访问层级.png)
...
![优化字面量与构造式](https://gitee.com/lilyn/pic/raw/master/lagoulearn-img/优化字面量与构造式.png)
